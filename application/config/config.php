...
$config['csrf_exclude_uris'] = array('api/v1/api/authentication','api/v1/api/add_lead',
    ...
    'api/v1/api/multiple_leads_assign','api/v1/api/authenticationnew','api/v1/api/refresh_dashboardnew',
    ...
    'api/v1/api/customer_retention_lead','api/v1/api/customer_retention_list','api/v1/api/customer_retention_detail','api/v1/api/customer_retention_remark_update'
    );
