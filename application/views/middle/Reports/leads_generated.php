...
<div class="lead-form">
    ...
    <div class="container">
        <p><strong>Purpose :</strong>This report shows total lead generated in the time period specified</p>
    <div class="form">
        ...
        <div class="container clearfix">
            ...
            <div class="float-right">
                <?php if(in_array($this->session->userdata('admin_type'),array('ZM','GM'))){ ?>
                        ...
                        ?>
                        <a href="<?php echo site_url('charts/index/leads_generated/'.$chart_param)?>" class="btn-Download">
                            Chart View
                        </a>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                <?php }?>
                                ...
                                <?php 
                                    if(in_array($viewName,array('ZM','BM'))){
                                        if($view == 'employee'){
                                                ...
                                                ?>
                                                <a class=""
                                                   href="<?php echo site_url('reports/index/leads_generated/employee' . $param) ?>">
                                                    Employee View
                                                </a>
                                                <?php
